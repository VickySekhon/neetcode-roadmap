...
const grades: number[] = [96,75,75,75,96,23];
//                       [1, 3, 3, 3,,1 , 6]

// const newArr: number[] = new Array(grades.length).fill(0);
const newArr: number[] = [...Array(grades.length).keys()];

const uniqueGrades: Set<number> = new Set(grades);
